...
const STORAGE_KEYS = {
  logs: "reader-star.logs",
  activeLogId: "reader-star.activeLogId",
  readingPositions: "reader-star.readingPositions",
  layout: "reader-star.layout",
  fontSize: "reader-star.fontSize",
  lineHeight: "reader-star.lineHeight",
} as const;
